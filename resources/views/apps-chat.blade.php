        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-xl-12">
                <div class="chat-detail">
                    ...
                    <div id="chatBody" class="chat-body scroll-container">
                        <div class="chat-day text-center mb-6">
                        ...
                        <div class="chat-messagebar">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <button class="btn btn-secondary-rgba" type="button" id="button-addonmic"><i
                                            class="feather icon-mic"></i></button>
                                </div>
                                <div id="submit" class="chat-input bg-white form-control"
                                    placeholder="Type a message..." aria-label="Text" contenteditable="">
                                </div>

                                <div class="input-group-append">
                                    <button class="btn btn-secondary-rgba" type="submit" id="button-addonlink"><i
                                            class="feather icon-link"></i></button>
                                    <button class="btn btn-primary-rgba" type="button" id="button-addonsend"><i
                                            class="feather icon-send"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
